...
function VenueBlurb() {
  return (
    <section>
      <p>
        Vue Croydon Grant&apos;s is part of the Vue cinema chain, one of the
        UK&apos;s largest cinema operators. Located on the High Street in{" "}
        <Link href="/london-cinemas/croydon/">Croydon</Link>, South London, the
...
export const seoDescription = "mainstream multiplex on Croydon High Street";
