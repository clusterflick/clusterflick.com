  ...
  return (
    <section>
      <p>
        ...
        team behind The Castle Cinema in Hackney, reopening in late 2025 after
        the previous Sidcup Storyteller closed. The venue programmes a broad
        variety of cinematic content including the best new releases,
        ...
        an invaluable local asset for Sidcup and the wider Bexley area.
      </p>
      <p>
