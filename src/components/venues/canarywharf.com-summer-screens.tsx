  ...
  return (
    <section>
      ...
      <p>
        ...
        grass. The programme also includes live sport, music quizzes, and
        big-screen gaming alongside the film nights, making it one of East
        London&apos;s most popular free summer events.
      </p>
    </section>
  );
}
...
export const seoDescription =
  "free open-air cinema in Canada Square Park, Canary Wharf";
export const seoHighlights =
  "blockbusters, Bollywood, cult classics and new releases — free entry";
