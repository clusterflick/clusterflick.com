function VenueBlurb() {
  return (
    <section>
      <p>
        Everyman Chelsea is part of the Everyman cinema group, a boutique chain
        known for its intimate, living-room-style cinema experience. Located on
        the King&apos;s Road in Chelsea, southwest London, the venue offers
        ...
        arthouse films. The cinema also features a stylish bar area for pre- and
        post-film drinks.
      </p>
      <p>
