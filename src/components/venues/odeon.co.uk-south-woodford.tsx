function VenueBlurb() {
  return (
    <section>
      <p>
        ODEON South Woodford is part of the ODEON cinema chain, one of the
        UK&apos;s oldest and largest cinema operators. Located on the High Road
        in South Woodford, northeast London, the venue features multiple screens
