  ...
  return (
    <section>
      <p>
        ...
        and concession stands serving the usual cinema snacks and drinks. Its
        position within one of London&apos;s largest shopping centres makes it a
        convenient option for combining a film with shopping or dining.
      </p>
    </section>
  );
}
