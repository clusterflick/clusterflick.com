function FilmClubBlurb() {
  return (
    <section>
      <p>
        Taste Film is an immersive cinematic dining experience, pairing a
...
export const seoDescription =
  "immersive cinematic dining — a tasting menu paired course by course with a film screening";
